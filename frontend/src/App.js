    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#2D46EB" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#2D46EB" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#2D46EB" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #2D46EB, #2D46EB , #2D46EB)" : "#666",
